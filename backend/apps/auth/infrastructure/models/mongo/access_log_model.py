...
class AccessLog(Document):
    ...
    user_id: Annotated[
        str, Indexed(str)
    ]  # Clave foránea al ID del usuario en PostgreSQL. Indexado para búsquedas rápidas.
    ip_address: str
    user_agent: str
    process_name: str = Field(
        description="Nombre descriptivo del proceso o acción que se intenta guardar"
    )
